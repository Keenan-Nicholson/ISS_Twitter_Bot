...
const job = schedule.scheduleJob(rule, function() {
    ...
    function readDataSJ(){
        try {
            const data = fs.readFileSync('C:\\Users\\keena\\Documents\\ISSTwitterBotSourceCode\\twitterBot\\locDataSJ.txt', 'utf8');
            return data;
        } catch (err) {
            console.error(err);
        }
    ...
    function readDataCB(){
        try {
            const data = fs.readFileSync('C:\\Users\\keena\\Documents\\ISSTwitterBotSourceCode\\twitterBot\\locDataCB.txt', 'utf8');
            return data;
        } catch (err) {
            console.error(err);
        }
    ...
    function readDataGFW(){
        try {
            const data = fs.readFileSync('C:\\Users\\keena\\Documents\\ISSTwitterBotSourceCode\\twitterBot\\locDataGFW.txt', 'utf8');
            return data;
        } catch (err) {
            console.error(err);
        }
